...
`js-ephemeris-lite` 的可选亮星数据包。它原样携带 C++ Taiyin 生成的完整
TSC1 v1 lite 星表，包含 2,114 条恒星/特殊方向记录和 9,621 个可搜索别名；
...
- C++ Taiyin `stars-bright-v5.tsc1` lite 表的全部 2,114 条记录；
- 其中 2,111 颗是星表视星等 `V <= 5.0` 的亮星；
- 为保证双鱼座覆盖额外保留约 5.23 等的 Alrescha；
- 另外保留银河中心等两个无星等特殊方向记录；
- 明确保留二十八宿距星及中文、拼音别名，并覆盖十二黄道星座代表星；
...
```text
93fac4f1bf6c8ea451bda488ef152c60f9e89912e0efa2cc17f4b47f3edc5101
```
