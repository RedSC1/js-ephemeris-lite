import {
  AU_KM, earthHeliocentricState, moonGeocentricState,
...
/** Internal factory: the caller supplies the planetary state resolver. */
export function createApparentEvaluator(planetHeliocentricState) {
  ...
  function apparentGeometry(body, jdTT, options = {}) {
  ...
  function apparentBodyPosition(body, jdTT, options = {}) {
  ...
  function apparentBodyState(body, jdTT, options = {}) {
  ...
  return { apparentGeometry, apparentBodyPosition, apparentBodyState };
}
