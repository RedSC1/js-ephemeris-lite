...
export function searchCrossings(evaluate: (time: number) => number, start: number, end: number, options?: SearchOptions): Array<{ time: number }>;
export function searchAngleCrossings(evaluateDegrees: (time: number) => number, targetDeg: number, start: number, end: number, options?: SearchOptions): Array<{ time: number }>;
